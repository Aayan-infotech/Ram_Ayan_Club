    ...
    <div class="main-footer__middle">
        <div class="container">
            <div class="row gutter-y-40">
                <div class="col-md-6 col-lg-4 col-xl-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
    ...
    <div class="header-right-sidebar__content">
        ...
        <div class="header-right-sidebar__logo-box">
            <a href="#" aria-label="logo image"> <img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-landing.png" width="158"
                    alt="gotur">
            </a>
        </div>
