...
<head>
    ...
    <meta name="author" content="Ram Ayan Club">
    ...
    <title>Ram Ayan Club</title>

    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/logo/ramayan_logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/logo/ramayan_logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/logo/ramayan_logo.png">
...
<body class="custom-cursor">
    ...
    <div class="preloader">
        <div class="preloader__image" style="background-image: url(assets/images/logo/ramayan_logo.png);"></div>
    </div>
    <!-- /.preloader -->
    <div class="page-wrapper">
                            ...
                            "responsive": {
                                ...
                                <div class="item">
                                    <div class="destinations-card-two wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="destinations-card-two__thumb">
                                            <img src="assets/images/places/ayodhya.png" alt="destinations image">
                                        </div>
                                ...
                                <div class="item">
                                    <div class="destinations-card-two wow fadeInUp" data-wow-duration='1500ms'
                                        data-wow-delay='100ms'>
                                        <div class="destinations-card-two__thumb">
                                            <img src="assets/images/places/kashi.png" alt="destinations image">
                                        </div>
                                        <!-- /.destinations-card-two__thumb -->
                                    </div>
                                    <!-- /.destinations-card-two -->
                                ...
                                <div class="item">
                                    <div class="destinations-card-two wow fadeInUp" data-wow-duration='1500ms'
                                        data-wow-delay='100ms'>
                                        <div class="destinations-card-two__thumb">
                                            <img src="assets/images/places/mathura.png" alt="destinations image">
                                        </div>
                                        <!-- /.destinations-card-two__thumb -->
                                    </div>
                                    <!-- /.destinations-card-two -->
                                ...
                                <div class="item">
                                    <div class="destinations-card-two wow fadeInUp" data-wow-duration='1500ms'
                                        data-wow-delay='100ms'>
                                        <div class="destinations-card-two__thumb">
                                            <img src="assets/images/places/chitrakoot.png" alt="destinations image">
                                        </div>
                                        <!-- /.destinations-card-two__thumb -->
                                    </div>
                                    <!-- /.destinations-card-two -->
                                ...
                                <div class="item">
                                    <div class="destinations-card-two wow fadeInUp" data-wow-duration='1500ms'
                                        data-wow-delay='100ms'>
                                        <div class="destinations-card-two__thumb">
                                            <img src="assets/images/places/prayag.png" alt="destinations image">
                                        </div>
                                        <!-- /.destinations-card-two__thumb -->
                                    </div>
                                    <!-- /.destinations-card-two -->
                    ...
                    <div class="col-lg-6">
                        <div class="about-two__thumb wow fadeInLeft" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            <div class="about-two__thumb__item  ">
                                <img src="assets/images/places/kashi.png" alt="gotur image">
                            </div>
                            <!-- /.about-two__thumb__item -->
                            <div class="about-two__thumb__item-small  ">
                                <img src="assets/images/places/prayag.png" alt="gotur image">
                            </div>
                            <!-- /.about-two__thumb__item -->
        ...
        <section class="destination-filter section-space" id="destination">
            ...
            <div class="destination-filter__element-two">
                <img src="assets/images/shapes/monjil.png" alt>
            </div>
            <!-- /.destination-filter__element -->
        </section>
        <!-- /.destination-filter -->
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="cta-five__shape wow fadeInRight" data-wow-duration="1500ms"
                                data-wow-delay="400ms">
                                <img src="assets/images/shapes/cta-1-1.png" alt>
                            </div>
                            <!-- /.cta-five__content -->
                        </div>
                        <!-- /.col-lg-6 -->
                    ...
                    "responsive": {
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                ...
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/INNOVA_CRYSTA.png" alt="taxi">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/INNOVA.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/DZIRE.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/AURA.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/ERTIGA.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/XL6.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/KIA_CARENS.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                        ...
                        <div class="item">
                            <div class="listing-card-four wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="listing-card-four__image">
                                    <img src="assets/images/cars/TRAVELER.png" alt="taxi">
                                    <div class="listing-card-four__btn-group">
                    ...
                    <div class="col-xl-6">
                        <div class="testimonials-three__top">
                            <div class="testimonials-three__thumb wow fadeInLeft" data-wow-duration='1500ms'
                                data-wow-delay='400ms'>
                                <img src="assets/images/resources/testi--3-1.png" alt="testimonial image">
                            </div>
                ...
                "responsive": {
                    ...
                    <div class="blog-card-two blog-card-two--two">
                        <div class="blog-card-two__image">
                            <img src="assets/images/blog/blog-2-7.jpg" alt="The Surfing Man Will Blow Your Mind">
                            <a href="#" class="blog-card-two__image__link"><span class="sr-only">The Surfing Man Will
                                    Blow Your Mind</span></a>
                        </div>
                        <div class="blog-card-two__content">
                            <div class="blog-card-two__top">
                                ...
                                <ul class="list-unstyled blog-card-two__meta">
                                    <li><a href="#"><i class="fa-solid fa-user"></i> Priyanshi Rajput</a></li>
                                </ul>
                            </div>
                            <h3 class="blog-card-two__title"><a href="#">The Surfing Man Will Blow Your Mind</a></h3>
                            <a href="#" class="blog-card-two__content__btn"> Read More <i
                    ...
                    <div class="blog-card-two blog-card-two--two">
                        <div class="blog-card-two__image">
                            <img src="assets/images/blog/blog-2-8.jpg" alt="Varanasi Ganga Aarti Experience">
                            <a href="#" class="blog-card-two__image__link"><span class="sr-only">Varanasi Ganga
                                    Aarti</span></a>
                        </div>
                        <div class="blog-card-two__content">
                            <div class="blog-card-two__top">
                                <div class="blog-card-two__date">
                                    <span class="blog-card-two__date__day">05</span>
                                    <span class="blog-card-two__date__month">Apr</span>
                                </div>
                                <ul class="list-unstyled blog-card-two__meta">
                                    <li><a href="#"><i class="fa-solid fa-user"></i> Ramesh Sharma</a></li>
                                </ul>
                            </div>
                            <h3 class="blog-card-two__title"><a href="#">Divine Ganga Aarti in Varanasi</a></h3>
                            <a href="#" class="blog-card-two__content__btn"> Read More <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="blog-card-two blog-card-two--two">
                        <div class="blog-card-two__image">
                            <img src="assets/images/blog/blog-2-9.jpg" alt="Golden Temple Visit">
                            <a href="#" class="blog-card-two__image__link"><span class="sr-only">Golden
                                    Temple</span></a>
                        </div>
                        <div class="blog-card-two__content">
                            <div class="blog-card-two__top">
                                <div class="blog-card-two__date">
                                    <span class="blog-card-two__date__day">12</span>
                                    <span class="blog-card-two__date__month">May</span>
                                </div>
                                <ul class="list-unstyled blog-card-two__meta">
                                    <li><a href="#"><i class="fa-solid fa-user"></i> Simran Kaur</a></li>
                                </ul>
                            </div>
                            <h3 class="blog-card-two__title"><a href="#">Peaceful Morning at Golden Temple</a></h3>
                            <a href="#" class="blog-card-two__content__btn"> Read More <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="blog-card-two blog-card-two--two">
                        <div class="blog-card-two__image">
                            <img src="assets/images/blog/blog-2-10.jpg" alt="Kedarnath Temple Trek">
                            <a href="#" class="blog-card-two__image__link"><span class="sr-only">Kedarnath
                                    Yatra</span></a>
                        </div>
                        <div class="blog-card-two__content">
                            <div class="blog-card-two__top">
                                <div class="blog-card-two__date">
                                    ...
                                    <span class="blog-card-two__date__month">Jun</span>
                                </div>
                                <ul class="list-unstyled blog-card-two__meta">
                                    <li><a href="#"><i class="fa-solid fa-user"></i> Ankit Verma</a></li>
                                </ul>
                            </div>
                            <h3 class="blog-card-two__title"><a href="#">Kedarnath Trek – A Spiritual Journey</a></h3>
                            <a href="#" class="blog-card-two__content__btn"> Read More <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
        ...
        <footer class="main-footer">
                ...
                <div class="container">
                    <div class="main-footer__top__inner wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="footer-widget__logo logo-retina">
                            <a href="#"><img src="assets/images/logo/ramayan_logo.png" width="160" height="150"
                                    alt="logo"></a>
                        </div>
                        <!-- /.footer-widget__logo -->
                        <ul class="list-unstyled footer-widget__list">
                            <li>
                                <div class="footer-widget__list__icon">
                                    <i class="fas fa-envelope"></i>
                                </div>
            ...
            <div class="main-footer__middle">
                <div class="container">
                    <div class="row gutter-y-40">
                        <div class="col-md-6 col-lg-4 col-xl-6 wow fadeInUp" data-wow-duration="1500ms"
                            data-wow-delay="00ms">
                            <div class="footer-widget footer-widget--about">
                                <h2 class="footer-widget__title">About Ram Ayan Club</h2>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp col-6" data-wow-duration="1500ms"
                            ...
                            <div class="footer-widget footer-widget--post">
                                ...
                                <!-- /.footer-widget__title -->
                                <ul class="list-unstyled footer-widget__links">
                                    <li class="scrollToLink"><a href="#booking">Book Fleet</a></li>
